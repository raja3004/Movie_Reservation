...
<div class="container">
  <main>
    <div class="py-5 text-center">
      ...
      <h6 style="font-size:70px;">Payment Gateway</h6>
      <h6>&#42; Please do not click back or reload button &#42;</h6>
    </div>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="center">
    <div class="row g-5" width="100px">
      <div class="col-md-5 col-lg-4 order-md-last center" >
        <h4 class="d-flex justify-content-between align-items-center mb-3 " width="100px">
          <span class="text-primary" style="font-size:50px;width=100px;">Booking Summary</span>
        ...
        <br><br><br>
        <li>
            <span class="center"> <form action="p1_cc.php">
