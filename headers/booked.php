...
?>
<div class="dropdown">
<a href="#" class="btn btn-secondary dropdown-toggle"  id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" style="text-decoration: none;background-color:rgba(var(--bs-dark-rgb),var(--bs-bg-opacity))!important;border-color:rgba(var(--bs-dark-rgb),var(--bs-bg-opacity))!important;" ><img style= "border-radius:20px;width:48px" src="https://www.tutorialrepublic.com/examples/images/avatar/3.jpg" class="avatar" alt="Avatar"><span> <?php echo $_SESSION['user_name'] ?> </span><b class="caret"></b></a>
...
<div class="container">
  <main>
    <div class="py-5 text-center">
      <img class="d-block mx-auto mb-4" src="popc.png" alt="" width="72" height="72">
      <h6 style="font-size:70px;">Successfully Booked !</h6>
      <h6></h6>
    </div>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="center">
    <div class="row g-5" width="100px">
      <div class="col-md-5 col-lg-4 order-md-last center" >
        <h4 class="d-flex justify-content-between align-items-center mb-3 " width="100px">
          <span class="text-primary" style="font-size:50px;width=100px;align">Booked Summary</span>
          
        </h4>
        <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              <h6 class="my-0" id="ticket"></h6><br>
              <small class="text-muted" ><b>FIR - Tamil (U/A)</b></small><br>
          ...
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div>
              <h6 class="my-0">K.G CINEMAS</h6>
              <span class="text-muted">11.25 AM</span>
            </div>
       ...
       <!--
      <?php
         $to = "rnagaraj3004@gmail.com";
         $subject = "This is subject";
         
         $message = "<b>This is HTML message.</b>";
         $message .= "<h1>This is headline.</h1>";
         
         $header = "From:offraja3004@gmail.com \r\n";
         $header .= "Cc:cb.en.u4cse19640@cb.students.amrita.edu \r\n";
...
<br>      
          <div>
          <input  style="display:none" type="text" class="form-control" id="postTicket" name ="tickets" value=""  >
          </div>
        </form>
      </div>
    </div>
...
window.onload=function(){
  var ticket;
  ticket=localStorage.getItem("tickets");
  var price=localStorage.getItem("ticketPrice");
  
    document.getElementById("ticket").innerHTML=ticket;
    document.getElementById("postTicket").value = ticket;
    document.getElementById("price").innerHTML='Rs.'+ ' '+price;
    var total=Number(price)+200;
